...
<div class="h-screen w-full flex bg-gray-100">
	...
	<aside
		class="hidden h-screen lg:flex flex-col items-center bg-white text-gray-700 shadow
		  ">
		<!-- Side Nav Bar-->

		<div class="h-16 flex items-center w-full">
			<!-- Logo Section -->
			<a class="h-6 w-6 mx-auto" href="http://localhost/frontend/">
				<img
	...
	<div class="flex-1 flex flex-col overflow-hidden">
		<nav class="px-4 flex justify-between bg-white h-16 border-b-2 sticky top-0">
			<!-- top bar -->
        ...
        <button type="submit" class="absolute right-0 top-0 mt-2 md:mt-3 mr-4">
          <svg class="text-gray-600 h-3 w-3 md:h-4 md:w-4 fill-current  transition hover:text-gray-900" xmlns="http://www.w3.org/2000/svg"
	...
	<nav
		...
		<a
			...
			<span class="hidden text-sm capitalize">saved</span>
		</a>
		...
		<a
			...
			<span class="hidden text-sm capitalize">messages</span>
		</a>		
